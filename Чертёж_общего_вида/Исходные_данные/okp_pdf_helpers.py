...
class Sheet:
    ...
    def leader(self,anchor,shelf,label,left=False):
    ...
    def dimh(self,x1,x2,y,from1,from2,label):
        self.line((x1,from1),(x1,y+2),.18);self.line((x2,from2),(x2,y+2),.18)
    ...
    def dimv(self,y1,y2,x,from1,from2,label):
        self.line((from1,y1),(x+2,y1),.18);self.line((from2,y2),(x+2,y2),.18)
